...
if __name__ == '__main__':
    ...
    max_pr_num = 3420
   # "openzipkin/zipkin"
    owner_name = "openzipkin"  # "spring-projects"  # "symfony"#"rails"#"angular" #"tensorflow"
    repo_name = "zipkin"  # "spring-framework"  # "spring-boot" #"symfony"#"rails"#"angular.js"#"tensorflow"
