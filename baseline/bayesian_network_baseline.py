...
if __name__ == '__main__':
    repo_name ="guacamole-client"#"#"storm"#"scikit-learn"#"moby"#"cocos2d-x"#"netbeans"#"yii2"##"dubbo"#"react"#"tensorflow"#"opencv"#"phoenix"#"helix"#"terraform"#"Ipython"#"kuma"#"incubator-heron"#"Katello"#"zipkin"#"incubator-heron"
    # ranklib所能调的库
