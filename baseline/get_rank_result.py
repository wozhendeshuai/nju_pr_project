...
if __name__ == '__main__':
    repo_name = "zipkin"#"yii2"  # "dubbo"#"react"#"tensorflow"#"opencv"#"phoenix"#"guacamole-client"#"helix"#"terraform"  # "salt"  # "zipkin"#"angular.js"  # "tensorflow"  # "symfony"# #"spring-boot"#"spring-framework"#"rails"
    file_path_tmp = []
    alg_dict = {
        0: "MART",
        1: "RankNet",
