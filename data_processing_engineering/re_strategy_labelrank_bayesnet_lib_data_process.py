...
def get_data_by_repo_name(repo_name):
    ...
    # todo: 重新修改labels策略这里计算每个prNumber对应的真实速度编号
...
if __name__ == '__main__':
    repo_name = "yii2"#"dubbo"#"react"#"tensorflow"#"opencv"#"phoenix"#"guacamole-client"# "guacamole-client"#"helix"#"terraform"#"Ipython"#"kuma"#"incubator-heron"#"Katello"#"salt"#"zipkin"  # "angular.js"  # "tensorflow"  # "symfony"# #"spring-boot"#"spring-framework"#"rails"
